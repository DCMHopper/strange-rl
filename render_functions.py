...
def render_bar(console: Console, current_value: int, max_value: int, total_width: int) -> None:
	...
	console.draw_rect(x = 0, y = 63, width = total_width, height = 1, ch = 1, bg = color.bar_empty)

	if bar_width > 0:
		console.draw_rect(x = 0, y = 63, width = bar_width, height = 1, ch = 1, bg = color.bar_filled)

	console.print(x = 8, y = 63, string = f"{current_value}/{max_value}", fg = color.bar_text)
